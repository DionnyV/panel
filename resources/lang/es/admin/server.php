...
return [
    ...
    'alerts' => [
        ...
        'server_created' => 'El servidor se creó correctamente en el panel. Por favor, espere unos minutos al daemon para instalar completamente este servidor.',
        'build_updated' => 'Los detalles de compilación para este servidor se han actualizado. Algunos cambios pueden requerir un reinicio para que surtan efecto.',
        'suspension_toggled' => 'El estado de suspensión del servidor se ha cambiado a :status.',
        'rebuild_on_boot' => 'Este servidor se ha marcado como que requiere una reconstrucción del Contenedor Docker. El servidor se reconstruirá la próxima vez que se inicie.',
        ...
        'docker_image_updated' => 'Se cambió correctamente la imagen predeterminada de Docker para usar en este servidor. Se requiere un reinicio para aplicar este cambio.',
